        ...
        return (
          <div className={classes.ContentWrapper}>
            ...
            <span className={classes.ParagraphWrapper}>
              <p>
                On registration, Criticker asks for your email address, name, age, and country. Your email address is
                the only field which is required information, because it is necessary in case your password is lost. The
                other personal information is for building interesting statistics but is not required.
              </p>
            </span>
            <br />
            ...
            <span className={classes.ParagraphWrapper}>
              <p>
                Criticker.com will not share your email address, user name, ip address or other information that could
                be used to identify you, with any third party. We will not make your email address visible to other
                users.
              </p>
            </span>
            <br />
            ...
            <span className={classes.ParagraphWrapper}>
              <p>
                ...
                receive any. Criticker may still send you emails when legally required to do so -- such as when there is
                a change to this privacy policy or information regarding your account.
              </p>
            </span>
            <br />
            <h2>
            ...
            <span className={classes.ParagraphWrapper}>
              <p>
                Criticker.com uses a tool which collects requests for pages and passes elements of them to search
                engines to assist them in indexing this site. We control the configuration of the tool and are
            ...
            <span className={classes.ParagraphWrapper}>
              <p>
                We use third-party advertising companies to serve ads when you visit our Web site. These companies may
                use aggregated information (not including your name, address, email address or telephone number) about
                your visits to this and other Web sites in order to provide advertisements about goods and services of
                interest to you. If you would like more information about this practice and to know your choices about
          ...
          <div className={classes.ContentWrapper}>
            ...
            <span className={classes.ParagraphWrapper}>
              <p>
                ...
                to <a href="mailto:18014017@stu.mmu.ac.uk">info@criticker.com</a> and we will deal with it. Corrective
                action may include removal of the offending mini-review, removal of all the offending user's
                mini-reviews and, in extreme cases, suspension of the offending user's account.
              </p>
            </span>
            <br />
            ...
            <span className={classes.ParagraphWrapper}>
              <p>
                ...
                strives to foster an open atmosphere and users are encouraged to type whatever they please, regardless
                of how 'colorful' the language. Keep in mind that we are the final judges of what meets our definition
                of abuse, and we're pretty lenient.
              </p>
            </span>
            <br />
          </div>
          ...
          <div className={classes.ContentWrapper}>
            ...
            <span className={classes.ParagraphWrapper}>
              <p>
                ...
                able to supply links to full reviews on the website you represent, and receive extra traffic and
                exposure. If you're interested, send an email to{' '}
      ...
      case 'about':
        return (
          <div className={classes.ContentWrapper}>
            ...
            <span className={classes.ParagraphWrapper}>
              <p>
                We hated Shrek 2 and were shocked that nobody agreed with us. In vain, we searched for friends who
                shared our opinion: Shrek 2 was nothing more than unfunny puns strung together by slick and soulless
                animation. And that donkey is the most annoying character in cinema history.
              </p>
              <br />
              <p>
                But no! Shrek 2 was universally loved! Only with much hard work did we discover others who shared our
                vehemenence. They exist, those rare people with tastes similar to ours, and nowadays we listen closely
                to their opinions. The experience taught us that it's not enough to read reviews and talk with friends
                -- you get the best recommendations from the people whose tastes best match yours. The idea of Criticker
            ...
            <span className={classes.ParagraphWrapper}>
              <p>
                ...
                interesting to a small group of geeks people, we make it available. You can see exactly why a certain
                user is in your top 10, or why a particular title was recommended. If you want, you can sit there with a
                pen and paper and do the math yourself (geek heaven!) Also, we're honest: Criticker will never push
                anything upon you -- if the math predicts that you'll hate a new blockbuster, that's what we'll tell
                you!
              </p>
            </span>
            <h2>
      ...
      case 'terms':
        return (
          <div className={classes.ContentWrapper}>
            ...
            <span className={classes.ParagraphWrapper}>
              <p>
                Welcome to Criticker. If you continue to browse and use this website, you are agreeing to comply with
            ...
            <span className={classes.ParagraphWrapper}>
              <p>
                The term 'Criticker' or 'us' or 'we' refers to the owner of the website. The term 'you' refers to the
            ...
            <ul>
              ...
              <li>
                ...
                provide further information. They do not signify that we endorse the website(s). We have no
            ...
            <ul>
              ...
              <li>
                When you publish a mini-review on Criticker, you are allowing everyone, including non-registered users
                of Criticker, to access and view that information, and to associate it with you (i.e., your profile name
                & picture).
              </li>
              <li>
                We appreciate your feedback or other suggestions about Criticker, but you understand that we may use
